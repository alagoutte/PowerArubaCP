...
function Add-ArubaCPCertSignRequest {
    ...
    <#
        .SYNOPSIS
        Add a Certificate Sign Request on ClearPass

        .DESCRIPTION
        Add a Certificate Sign Request (CSR) on ClearPass
        ...
        Add a Certificate Sign Request with Common Name MyPowerArubaCP (with default other settings)
        ...
        Add a Certificate Sign Request with custom certificate settings (CN, Organization, State...) and RSA-2048 with SHA-256 for cipher/digest algorithm
    ...
    Process {
        ...
        #   $_csr | Add-Member -name "type" -MemberType NoteProperty -Value $type
